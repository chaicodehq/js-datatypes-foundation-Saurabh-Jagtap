...
export function createPaanOrder(basePaan, customizations) {
  ...
  let paan = basePaan
  if (typeof customizations !== 'object') return Object.assign({}, paan)
  return Object.assign({}, paan, customizations)
}
...
export function updatePrices(menu, increase) {
  ...
  let obj = Object.entries(menu)
  let updatedprice = obj.map(([item, price]) => {
